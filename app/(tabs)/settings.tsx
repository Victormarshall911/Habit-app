    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
            <ScrollView contentContainerStyle={{ paddingTop: insets.top + Spacing.lg, paddingBottom: 120 }} showsVerticalScrollIndicator={false}>
                ...
                <SettingRow icon="notifications" iconColor={colors.primary} title="Habit Reminders" subtitle="Get reminded every 4 hours" delay={100}
                ...
                <SettingRow icon="time" iconColor={colors.accent} title="Reminder Schedule" subtitle="8:00 AM · 12:00 PM · 4:00 PM · 8:00 PM" delay={150} />
